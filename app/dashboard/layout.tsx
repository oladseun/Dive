      ...
      <div className="flex-1 flex flex-col overflow-hidden relative">
        ...
        <header className="h-20 border-b border-slate-50 flex items-center justify-between px-10 bg-white/80 backdrop-blur-xl sticky top-0 z-30">
          ...
          <div className="flex items-center gap-4">
            <button className="w-10 h-10 flex items-center justify-center text-slate-400 hover:text-slate-900 hover:bg-slate-50 rounded-xl transition-all group relative">
